...
import (
	...
	dayeight2023 "github.com/sebastianring/aoc2022/2023/08_1"
)
...
func TestHauntedWastelandPartTwoDataTwo(t *testing.T) {
	result, err := dayeight2023.HauntedWastelandPartTwo("data3.txt")
